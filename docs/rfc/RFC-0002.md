...
<!-- SIGNATURE: sha256:7684e4995c97290e469b06635311c0671eef9d51ea8ecbc3216da8d6e4c455c0 -->
...
Captured files MUST be staged for a dependent even when the producing task ran in a disposable worktree. A declared file is part of a task's output, not part of the workspace state that a worktree discards.
